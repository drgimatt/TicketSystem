 ...
 * @author boxro
 */
public class MySQLConnectorOrig {
    ...
    private static MySQLConnectorOrig dbObject;

    private MySQLConnectorOrig(){
    }

    public static MySQLConnectorOrig getInstance(){
        if (dbObject == null){
            dbObject = new MySQLConnectorOrig();
        }
        return dbObject;
    }
